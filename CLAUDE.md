# Forneatto Cucina — contexto para Claude Code

## O que e este repositorio

O site do **Forneatto Cucina**, servido em **https://forneattocucina.com.br**.
...
Este repositorio e **so o site do Forneatto Cucina**. Nao tem painel, nao tem API,
